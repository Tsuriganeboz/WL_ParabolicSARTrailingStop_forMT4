//+------------------------------------------------------------------+
//|                         WL_ParabolicSARTrailingStop_Strategy.mqh |
...
void WL_TrailingStopOrderSymbolMatch()
{
   for (int i = (OrdersTotal() - 1); i >= 0; i--)
   {
         ...
         )
      {
         ...
         {
            needExecute = needExecute || WL_TrailingStopUseParabolicSARForBuy(stopLossPrice, 
                                                                           ShiftStopLossPips);
         ...
         {         
            needExecute = needExecute || WL_TrailingStopUseParabolicSARForSell(stopLossPrice,
                                                                           ShiftStopLossPips);
